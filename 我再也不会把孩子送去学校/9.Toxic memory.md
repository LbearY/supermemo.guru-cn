...
由于学习不好，[学习驱动器](https：/supermemo.Guru/wiki/Learning_Drive)的减少可能是由于记忆积累较少所致，和更快的[遗忘](https：/supermemo.Guru/wiki/Forgetting)。 然而，寄生和有毒记忆的形成也可能导致对学校和学习的厌恶逐渐增加。



## 9.1 厌学

对学习的厌恶、对学校的憎恨，或者对某一特定学科(如数学)的憎恨，都是基于同样的机制：**有毒的记忆**。
